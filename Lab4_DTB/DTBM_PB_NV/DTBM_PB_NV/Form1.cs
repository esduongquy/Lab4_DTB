...
namespace DTBM_PB_NV
{
    ...
    {
        String strConn = @"Data Source=LAPTOP-6VQODKR8\SQLEXPRESS;Initial Catalog=lab04_DTB;Integrated Security=True";
        ...
        private void labelSoDT_Click(object sender, EventArgs e)
        {
